...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("/Users/wangmeng/荣智互联/停车场项目");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/parkinglot?characterEncoding=utf8");
...
//        strategy.setNaming(NamingStrategy.removePrefixAndCamel());// 表名生成策略
         strategy.setInclude(new String[] { "tb_customer","tb_customer_to_lot", "tb_integral", "tb_lot_detail", "tb_parkinglot", "tb_order" }); // 需要生成的表
