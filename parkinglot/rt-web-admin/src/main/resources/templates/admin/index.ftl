...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="###" class="logo">
            ...
            <span class="logo-mini">IHAGO</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Parkinglot</b></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer" style="text-align: center">
                                ...
                                <div  >
                                    <a href="javascript:logout();"  class="btn btn-default btn-flat">退出登录</a>
                                </div>
                            </li>
                        </ul>
                    </li>
