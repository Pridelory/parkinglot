...
<div class="container">
    <form class="form-horizontal" id="form" method="post" action="${ctx!}/admin/parkinglot/add">
        <div class="row">
            <div class="box-body">
                [#include "/admin/parkinglot/form.ftl"/]
    ...
    * }
        ...
        fields: {
            ...
            mobile: {
                ...
                validators: {
                    notEmpty: {
                        message: 'The count can not be null'
                    },
                    regexp: {
                        regexp: /^[0-9]*$/,
            ...
            position: {
                validators: {
                    notEmpty: {
                        message: 'choose at least one selection'
                    }
                }
            }
        }
